...
[INIT-PROMPT.md](./INIT-PROMPT.md)에 4가지 초기 셋업 프롬프트가 준비되어 있다.
...
셋업 완료 후 `batch-supervisor.md`로 배치 집필을 시작하거나, 소설 폴더에서 직접 `claude`를 열어 한 화씩 쓸 수 있다.
