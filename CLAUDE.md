...
| P9 | 메타 참조 금지 점검 | 본문(나레이션·대사·독백)에서 "X화에서", "지난 화", "프롤로그에서", "1부에서" 등 에피소드 번호·구조명으로 과거/미래를 지칭하는 표현이 없는지 전수 검사. 발견 시 날짜·장소·사건명으로 대체 |
...
7. **에피소드 구조 메타 참조 금지**: 본문(나레이션·대사·독백) 안에서 "3화에서", "56화에서 알게 된", "프롤로그에서", "1부에서" 등 에피소드 번호·구조명으로 과거를 지칭하지 않는다. 캐릭터는 자기 이야기가 '화'나 '프롤로그/1부' 등으로 나뉘어 있다는 사실을 모른다. 과거 사건은 **날짜, 장소, 사건명** 등 작중 정보로 지칭한다. ※ EPISODE_META, plot/, summaries/ 등 메타 영역에서의 화 번호·구조명 사용은 허용.
